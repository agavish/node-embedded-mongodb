...
var embeddedMongodb = {
    ...
    start: function (dbPath, logPath, dbPort, callback) {
        ...
        function awaitListeningPort() {
            ...
            client.on('error', function(error) {
                console.log('Client connection error: attempts=' + connectionAttempts + ', error=' + JSON.stringify(error));
                client.destroy();
    ...
    stop: function (callback) {
        ...
        var mongodStopCmd = 'mongo --eval ' +  '"' + 'db.getSiblingDB(' + "'" + 'admin' +  "'" + ').shutdownServer()' + '" --port ' + this.port;
